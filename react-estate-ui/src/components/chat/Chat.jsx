      ...
      <div className="messages">
        {
          showLastMsgs && chats?.map((c) => {
            if (c.senderID !== currentUser.id) {
              return (
                <div  key={c.id} className="message-container" style={{ backgroundColor: c.seenBy.includes(currentUser.id) || chat?.id == c.id ? "green" : "#fafafa" }}>
                  <span
                  ...
                  <span className="flex-column">
                    <p className="receiver-name">{c.receiver.username}</p>
